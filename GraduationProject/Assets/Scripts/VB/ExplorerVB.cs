...
public class ExplorerVB : MonoBehaviour
{
    public Text eText;
    ...
    public string arrangeUsingRoslyn(string codeVB)
    {
        var tree = VisualBasicSyntaxTree.ParseText(codeVB);
